...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		lblUbtshallen.setFont(new Font("Helvetica", Font.BOLD, 25));
		lblUbtshallen.setBackground(new Color(240, 240, 240));
		lblUbtshallen.setBounds(123, 15, 189, 31);
		contentPane.add(lblUbtshallen);
		
		JLabel lblLinje = new JLabel("Linje");
		lblLinje.setForeground(Color.LIGHT_GRAY);
		lblLinje.setFont(new Font("Helvetica", Font.BOLD, 20));
		lblLinje.setBounds(12, 58, 56, 26);
		contentPane.add(lblLinje);
		
		JLabel lblDestination = new JLabel("Destination");
		lblDestination.setFont(new Font("Helvetica", Font.BOLD, 20));
		lblDestination.setForeground(Color.LIGHT_GRAY);
		lblDestination.setBounds(91, 58, 159, 26);
		contentPane.add(lblDestination);
		
		JLabel lblAvgar = new JLabel("Avg\u00E5r");
		lblAvgar.setForeground(Color.LIGHT_GRAY);
		lblAvgar.setFont(new Font("Helvetica", Font.BOLD, 20));
		lblAvgar.setBounds(337, 60, 76, 23);
		contentPane.add(lblAvgar);
		
		
		labelLinje1.setForeground(Color.WHITE);
		labelLinje1.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelLinje1.setBounds(12, 96, 84, 31);
		contentPane.add(labelLinje1);
		
		
		labelLinje2.setForeground(Color.WHITE);
		labelLinje2.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelLinje2.setBounds(12, 140, 84, 31);
		contentPane.add(labelLinje2);
		
		
		labelLinje3.setForeground(Color.WHITE);
		labelLinje3.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelLinje3.setBounds(12, 184, 84, 31);
		contentPane.add(labelLinje3);
		
		
		labelLinje4.setForeground(Color.WHITE);
		labelLinje4.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelLinje4.setBounds(12, 228, 84, 31);
		contentPane.add(labelLinje4);
		
		
		labelDes1.setForeground(Color.WHITE);
		labelDes1.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelDes1.setBounds(91, 96, 240, 31);
		contentPane.add(labelDes1);
		
		
		labelDes2.setForeground(Color.WHITE);
		labelDes2.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelDes2.setBounds(91, 140, 240, 31);
		contentPane.add(labelDes2);
		
		
		labelDes3.setForeground(Color.WHITE);
		labelDes3.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelDes3.setBounds(91, 184, 240, 31);
		contentPane.add(labelDes3);
		
		
		labelDes4.setForeground(Color.WHITE);
		labelDes4.setFont(new Font("Helvetica", Font.PLAIN, 18));
		labelDes4.setBounds(91, 228, 240, 31);
		contentPane.add(labelDes4);
		
		
		labelTime1.setForeground(Color.WHITE);
		labelTime1.setFont(new Font("Helvetica", Font.PLAIN, 20));
		labelTime1.setBounds(337, 97, 84, 31);
		contentPane.add(labelTime1);
		
		
		labelTime2.setForeground(Color.WHITE);
		labelTime2.setFont(new Font("Helvetica", Font.PLAIN, 20));
		labelTime2.setBounds(337, 141, 84, 31);
		contentPane.add(labelTime2);
		
		
		labelTime3.setForeground(Color.WHITE);
		labelTime3.setFont(new Font("Helvetica", Font.PLAIN, 20));
		labelTime3.setBounds(337, 185, 84, 31);
		contentPane.add(labelTime3);
		
		
		labelTime4.setForeground(Color.WHITE);
		labelTime4.setFont(new Font("Helvetica", Font.PLAIN, 20));
		labelTime4.setBounds(337, 229, 84, 31);
